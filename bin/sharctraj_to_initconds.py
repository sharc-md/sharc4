...
'''
    ...
    parser.add_option('-s', dest='stride', type=int, help="define the stride of the geometries to get, when specified --give_sing_out")
    ...
    parser.add_option('--give_single_out', action='store_true', dest='sing_out', help="Allows specifying a signle output.dat to use (default: automatically recurses into all subdirectories)")
