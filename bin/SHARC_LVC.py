    ...
    def run(self):
        ...
        if do_pc:
            ...
            mult_prefactors_v = np.stack(
                (
                    ...
                    R_v[..., 1] * r_inv3_v,    # y
                    R_v[..., 2] * r_inv3_v,    # z
                    R_v[..., 0] * R_v[..., 0] * r_inv5_v * 0.5,    # xx
                    R_v[..., 1] * R_v[..., 1] * r_inv5_v * 0.5,    # yy
                    R_v[..., 2] * R_v[..., 2] * r_inv5_v * 0.5,    # zz
                    R_v[..., 0] * R_v[..., 1] * r_inv5_v,    # xy
                    R_v[..., 0] * R_v[..., 2] * r_inv5_v,    # xz
                    R_v[..., 1] * R_v[..., 2] * r_inv5_v    # yz
                )
            )
        ...
        if do_pc:
            ...
            for im, n in filter(lambda x: x[1] != 0, enumerate(states)):
                ...
                # print(np.sum(fits_deriv[im][0,0, 1, :3, ...]**2, axis=0))
