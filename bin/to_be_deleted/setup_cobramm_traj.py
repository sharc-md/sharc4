...
import ast
from constants import HARTREE_TO_EV, U_TO_AMU, IToMult 
# =========================================================0
# some constants
DEBUG = False
...
def displaywelcome():
    ...
    string += '  ' + '=' * 80 + '\n'
    string += '||' + '{:^80}'.format('') + '||\n'
    string += '||' + '{:^80}'.format('Setup QM/MM trajectories for SHARC/COBRAMM dynamics') + '||\n'
    string += '||' + '{:^80}'.format('') + '||\n'
...
def get_general():
    ...
    string = '\n  ' + '=' * 80 + '\n'
    string += '||' + '{:^80}'.format('Initial conditions') + '||\n'
    string += '  ' + '=' * 80 + '\n\n'
    print(string)
...
''')
    ...
    # Interface
    string = '\n  ' + '=' * 80 + '\n'
    string += '||' + '{:^80}'.format('Choose the quantum chemistry interface') + '||\n'
    string += '  ' + '=' * 80 + '\n'
    print(string)
    ...
    # Dynamics options
    string = '\n  ' + '=' * 80 + '\n'
    string += '||' + '{:^80}'.format('Surface Hopping dynamics settings') + '||\n'
    string += '  ' + '=' * 80 + '\n\n'
    print(string)
    ...
    print('\n' + '{:-^60}'.format('Selection of Gradients and NACs') + '\n')
...
''')
    ...
    # Dynamics options
    string = '\n  ' + '=' * 80 + '\n'
    string += '||' + '{:^80}'.format('Content of output.dat files') + '||\n'
    string += '  ' + '=' * 80 + '\n'
    print(string)
...
In order to setup the COLUMBUS input, use the COLUMBUS input facility colinp. For further information, see the Spin-orbit tutorial for COLUMBUS [1].
...
def setup_all(INFOS):
    ...
    string = '\n  ' + '=' * 80 + '\n'
    string += '||' + '{:^80}'.format('Setting up directories...') + '||\n'
    string += '  ' + '=' * 80 + '\n\n'
    print(string)
