...
def test_write_geom():
    tests = [
        (
            ...
            "3\n\nS1  0.000000000000000 0.000000000000000 0.000841000000000\nH2  -0.000000000000000 0.974799000000000 1.182934000000000\nH3  -0.000000000000000 -0.974799000000000 1.182934000000000\n",
        ),
        (
            os.path.join(PATH, "inputs/molcas/geoms/QM2.in"),
            "10\n\nS1  0.000000000000000 0.000000000000000 0.000000000000000\nC2  0.000000000000000 0.000000000000000 -1.587500000000000\nH3  0.952500000000000 0.000000000000000 -2.116700000000000\nC4  -1.267509000000000 0.000000000000000 -2.291716000000000\nH5  -1.834145000000000 -0.889165000000000 -2.019263000000000\nH6  -1.834145000000000 0.889165000000000 -2.019263000000000\nC7  -1.026071000000000 0.000000000000000 -3.721474000000000\nH8  -1.978014000000000 0.000000000000000 -4.250365000000000\nH9  -0.459435000000000 0.889165000000000 -3.993927000000000\nH10  -0.459435000000000 -0.889165000000000 -3.993927000000000\n",
        ),
        (
            os.path.join(PATH, "inputs/molcas/geoms/QM3.in"),
            "2\n\nI1  0.000000000000000 0.000000000000000 0.000000000000000\nBr2  3.230431076994781 0.000000000000000 0.000000000000000\n",
        ),
    ]
