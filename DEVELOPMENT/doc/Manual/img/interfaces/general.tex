...
\tikzset{
  ...
  \node[anchor=west] (qc7)  at (  6,-2.1) {\textsc{Orca}};
  \node[anchor=west] (qc8)  at (  6,-2.7) {LVC};

  \node[anchor=west] (aux1) at (  5,-3.5) {\textsc{Wfoverlap}};
  \node[anchor=west] (aux2) at (  5,-4.1) {\textsc{TheoDORE}};
  \node[anchor=west] (aux3) at (  5,-4.7) {\textsc{Tinker}};
  \node[anchor=west] (aux4) at (  5,-5.3) {\textsc{PyQuante}};
...
\tikzset{
  ...
  \node[anchor=east] (tq2) at (4.0,4.4) {(QM/MM force field)};
  \node[anchor=east] (tq1) at (4.0,3.8) {(QM/MM table)};
  ...
  \draw[->] (tq2.east) to[bend left] (qc.50);
  \draw[->] (tq1.east) to[bend left] (qc.60);
  ...
  \draw[<->] (qc.240) to[bend right] (aux3.west);
  \draw[<->] (qc.230) to[bend right] (aux4.west);
