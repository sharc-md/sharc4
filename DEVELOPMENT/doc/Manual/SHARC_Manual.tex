...
In the second parallelization mode, used for numerical gradients, the central point and all displacements are computed in parallel. This mode will be used for CASPT2, MS-CASPT2 and Cholesky-CASSCF gradients and spin-orbit/dipole moment derivatives. In this mode there is no distinction between NCPU=1 and NCPU$\leq$0. 
