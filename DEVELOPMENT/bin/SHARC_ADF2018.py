...
version='2.1'
versiondate=datetime.date(2018,11,8)
...
# --------------------------------------------- ADF.resources ----------------------------------
    ...
    if 'theodore' in QMin:
        ...
        if 'PYTHONPATH' in os.environ:
            os.environ['PYTHONPATH'] = os.path.join(QMin['theodir'],'lib') + os.pathsep + os.path.join(QMin['ADFHOME'],'scripting') + os.pathsep + os.environ['PYTHONPATH']
